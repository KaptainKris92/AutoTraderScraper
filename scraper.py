...
if __name__ == "__main__":
    ...
    parser.add_argument("--scrape", action="store_true",
                        help="Scrape new ads from AutoTrader")
    parser.add_argument("--download", action="store_true",
                        help="Download images for saved ads")
    parser.add_argument("--limit", type=int, default=None,
                        help="Limit number of missing images to download (generally just used for debugging)")
    parser.add_argument("--max-scrolls", type=int, default=DEFAULT_MAX_SCROLLS,
                        help="How many times to scroll during scraping. (Alternatively, use `--scroll-until-end`)")
    parser.add_argument("--scroll-until-end", action="store_true",
                        help="Keep scrolling until all ads are loaded.")
