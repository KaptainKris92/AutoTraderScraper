...
4. Add your authtoken to your `.env` file: `NGROK_AUTHTOKEN=YourAuthToken`
...
## Using the app
1. Go to Settings to create a search profile with your search criteria.
2. Once the search profile is created, click the green 'Update table' button to scrape the latest ads.
3. 
